                    ...
                    <form action="AddLocation" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter location name" required autofocus>
                                ${mess}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="Time" name="timeOpen" class="form-control" placeholder="Time Open" required>
                                <label for="timeClose">Giờ đóng cửa:</label>
                                <input type="Time" name="timeClose" class="form-control" placeholder="Time Close" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="minPrice">Giá thấp nhất:</label>
                                <input type="number" name="minPrice" class="form-control" placeholder="Enter min price" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="maxPrice">Giá cao nhất:</label>
                                <input type="number" name="maxPrice" class="form-control" placeholder="Enter max price" required autofocus>
                            </div>
                            <div class="form-group">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit">Thêm địa điểm</button>
                    </form>
                </div><!--/span-->
                <div class="col-sm-2 sidenav">
                    <div>
