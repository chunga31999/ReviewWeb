    ...
    <body>
        ...
        <div class="container-fluid text-left">    
            <div class="row content">
                <div class="col-sm-2 sidenav"  style="padding-left: 40px">
                    <form action="List" method="post">
                        <label> <span class="glyphicon glyphicon-filter"></span> BỘ LỌC TÌM KIẾM</label>
                        <br>
                        <div class="form-group">
                            <label>Thể loại:</label><br>
                            <c:forEach items="${requestScope.typeL}" var="d">
                                <input type="checkbox" name="type" value="${d.getId()}">${d.getName()}
                                <br>
                            </c:forEach>
                        </div>
                        <div class="form-group">
                            <label>Mức giá</label><br>
                            Giá từ <input type="text" name="min" class="form-control" placeholder="đ">
                            đến <input type="text" name="max" class="form-control" placeholder="đ">
                        </div>
                        <!--<input type="text" class="form-control" placeholder="Search">-->
                        <button type="submit" class="btn btn-danger">Áp dụng <span class="glyphicon glyphicon-search"></span></button>
                    </form>
                </div>
                <div class="container col-sm-8 text-left"> 
                      ${paging}
                    <div class="row">
                        <c:forEach items="${requestScope.LocalL}" var="d">
                            <div class="col-sm-4 col-md-4">
                                <div class="thumbnail">
                                    <img src="image/${d.img}" style="width: 300px;height: 200px">
                                    <div class="caption">
                                        <a href="LocationDetail?id=${d.id}"><h3>${d.name}</h3></a>
                                        <p>${d.address}</p>
                                        <span class="label label-warning glyphicon glyphicon-star"> ${d.score}</span>
